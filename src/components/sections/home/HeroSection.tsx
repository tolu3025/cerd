...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative bg-dark min-h-[90vh] flex items-center pt-24 pb-16 md:py-24 overflow-hidden">
      ...
      <div className="max-w-[1240px] mx-auto w-full px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <FadeIn delay={0.4} direction="left" className="w-full max-w-md lg:max-w-lg">
